...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget _buildTradeItem(Trade trade, BuildContext context) {
    ...
    // Fix: ganti withOpacity ke Color.fromRGBO
    final hasilBgColor = trade.hasil == 'WIN'
        ? const Color(0x264CAF50) // win 15% opacity
        : trade.hasil == 'LOSS'
            ? const Color(0x26F44336) // loss 15% opacity
            : const Color(0x269E9E9E); // be 15% opacity
  ...
  Widget _buildEmptyState() {
    return Container(
      ...
      child: Column(
        children: [
          // Fix: ganti withOpacity ke Color langsung
          const Icon(Icons.inbox_outlined,
              color: Color(0x80606060), size: 64),
